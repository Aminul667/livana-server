...
const loginUser = (payload) => __awaiter(void 0, void 0, void 0, function* () {
    ...
    if (!userData) {
        throw new ApiErrors_1.default(http_status_1.default.CONFLICT, "User doesn't exists");
    }
...
const refreshToken = (token) => __awaiter(void 0, void 0, void 0, function* () {
    ...
    if (!userData) {
        throw new ApiErrors_1.default(http_status_1.default.CONFLICT, "This user is not found ");
    }
    const dataForToken = {
        userId: userData.id,
        email: userData.email,
...
const logInWithSocialMedia = (payload) => __awaiter(void 0, void 0, void 0, function* () {
    ...
    if (!user) {
        throw new ApiErrors_1.default(http_status_1.default.UNAUTHORIZED, "User does not exist. Please register first.");
    }
    const dataForToken = {
        userId: user.id,
        email: user.email,
